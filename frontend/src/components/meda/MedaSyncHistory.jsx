        ...
        <TableContainer sx={{ maxWidth: '100%', overflowX: 'auto' }}>
          <Table sx={{ minWidth: 950 }}>
            <TableHead>
              ...
              >
                <TableCell sx={{ color: '#1e293b', fontWeight: 800, fontSize: '0.72rem', textTransform: 'uppercase', letterSpacing: '0.6px', py: 1.8 }}>
                ...
                <TableCell sx={{ color: '#16a34a', fontWeight: 800, fontSize: '0.72rem', textTransform: 'uppercase', letterSpacing: '0.6px', py: 1.8 }}>
                  <Stack direction="row" alignItems="center" spacing={0.8}>
                    <CheckCircle2 size={13} color="#16a34a" />
                    <span>Success</span>
                  </Stack>
                </TableCell>
                <TableCell sx={{ color: '#dc2626', fontWeight: 800, fontSize: '0.72rem', textTransform: 'uppercase', letterSpacing: '0.6px', py: 1.8 }}>
                  <Stack direction="row" alignItems="center" spacing={0.8}>
                ...
                <TableCell sx={{ color: '#1e293b', fontWeight: 800, fontSize: '0.72rem', textTransform: 'uppercase', letterSpacing: '0.6px', py: 1.8 }} align="center">
                  Actions
                </TableCell>
              </TableRow>
            </TableHead>
      ...
      >
        ...
        <DialogActions sx={{ p: 2 }}>
          <Button 
            ...
            variant="contained"
            sx={{ background: 'linear-gradient(135deg, #10b981 0%, #059669 100%)', textTransform: 'none', borderRadius: 2.5, fontWeight: 800 }}
          >
            Close Details
          </Button>
        </DialogActions>
