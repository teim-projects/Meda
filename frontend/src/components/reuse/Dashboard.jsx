...
const Dashboard = ({ currentUser }) => {
  ...
  const CATEGORIES = [
    ...
    { id: 'solar-grid-conn', label: 'Grid Connected', icon: Sun, count: '642', capacity: '4,850 MW', color: '#ea580c', bg: '#ffedd5' },
    { id: 'solar-offgrid-sum', label: 'Off Grid', icon: Sun, count: '184', capacity: '420 MW', color: '#ca8a04', bg: '#fef9c3' },
    { id: 'kusum-ac', label: 'KUSUM', icon: Zap, count: '215', capacity: '1,280 MW', color: '#d97706', bg: '#fef3c7' },
    { id: 'mskvy', label: 'MSKVY', icon: Cpu, count: '128', capacity: '5,253.60 MW', color: '#0284c7', bg: '#e0f2fe' },
    { id: 'solar-rooftop', label: 'Rooftop', icon: Home, count: '2,410', capacity: '1,840 MW', color: '#059669', bg: '#ecfdf5' },
    { id: 'solar-grid', label: 'Solar Grid', icon: Sun, count: '310', capacity: '2,150 MW', color: '#eab308', bg: '#fef08a' },
    { id: 'mskvy-2', label: 'MSKVY 2.0', icon: Cpu, count: '156', capacity: '7,420 MW', color: '#0369a1', bg: '#e0f2fe' },
    { id: 'pm-kusum', label: 'PM Kusum Scheme', icon: Award, count: '195', capacity: '1,120 MW', color: '#2563eb', bg: '#dbeafe' },
    { id: 'govt-building-solar', label: 'Government Building Solar', icon: Building2, count: '94', capacity: '340 MW', color: '#4f46e5', bg: '#e0e7ff' },
    { id: 'wind', label: 'Wind', icon: Wind, count: '280', capacity: '3,210 MW', color: '#0891b2', bg: '#cff4fc' },
    { id: 'bagasse', label: 'Bagasse', icon: Leaf, count: '112', capacity: '1,890 MW', color: '#16a34a', bg: '#dcfce7' },
    { id: 'biomass', label: 'Biomass', icon: Flame, count: '76', capacity: '480 MW', color: '#059669', bg: '#d1fae5' },
    { id: 'small-hydro', label: 'Small Hydro Projects', icon: Droplets, count: '48', capacity: '370 MW', color: '#0284c7', bg: '#e0f2fe' },
    { id: 'municipal-waste', label: 'Municipal Solid Waste', icon: Trash2, count: '24', capacity: '160 MW', color: '#7c3aed', bg: '#f3e8ff' }
  ];
  ...
  return (
    <div className="meda-dashboard-wrap animate-fade-in">
      ...
      {activeTab === 'summary' ? (
        ...
        /* 4. GOVERNMENT BUILDING SOLARIZATION VIEW (Screenshot 4) */
        <div className="category-view-container animate-fade-in space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 max-w-[800px] mx-auto">
            <div className="executive-hero-card text-left p-5">
              <div className="ehc-badge-pill">GOVERNMENT SOLAR CAPACITY</div>
              <div className="pink-card-val text-3xl">61.00 <span className="pink-card-unit">MW</span></div>
              <div className="pink-card-lbl">Total Installed Capacity in MW</div>
            </div>

            <div className="executive-hero-card text-left p-5">
              <div className="ehc-badge-pill text-indigo-400 border-indigo-400/30 bg-indigo-500/10">BUILDING INSTALLATIONS</div>
              <div className="pink-card-val text-3xl">6,614</div>
              <div className="pink-card-lbl">Total No. Of Projects</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 chart-box-card light-card">
              <h3 className="chart-box-title">DISTRICT WISE SOLAR CAPACITY INSTALLED BY MW</h3>
              <div className="h-[260px] flex items-end gap-1.5 pt-6 pb-2 px-2 overflow-x-auto">
                {[
                  { d: 'Nagpur', mw: 1250, pct: 100 },
                  { d: 'Gadchiroli', mw: 690, pct: 55 },
                  { d: 'Pune', mw: 650, pct: 52 },
                  { d: 'Bhandara', mw: 400, pct: 32 },
                  { d: 'Chandrapur', mw: 310, pct: 25 },
                  { d: 'Yavatmal', mw: 280, pct: 22 },
                  { d: 'Satara', mw: 260, pct: 21 },
                  { d: 'Thane', mw: 240, pct: 19 },
                  { d: 'Hingoli', mw: 220, pct: 18 },
                  { d: 'Sangli', mw: 200, pct: 16 },
                  { d: 'Amravati', mw: 180, pct: 14 },
                  { d: 'Sambhajinagar', mw: 170, pct: 13.5 },
                  { d: 'Jalna', mw: 160, pct: 13 },
                  { d: 'Gondia', mw: 150, pct: 12 },
                  { d: 'Buldhana', mw: 140, pct: 11 },
                  { d: 'Parbhani', mw: 130, pct: 10 },
                ].map((item, idx) => (
                  <div key={idx} className="flex-1 flex flex-col items-center justify-end min-w-[32px] h-full group">
                    <span className="text-[9px] font-bold text-slate-600 mb-1 transition-all group-hover:scale-110 group-hover:text-indigo-600">{item.mw}</span>
                    <div className="w-full h-[170px] flex items-end justify-center bg-slate-100/70 rounded-t-md p-[2px]">
                      <div
                        className="w-full bg-gradient-to-t from-indigo-600 to-purple-400 rounded-t-sm group-hover:from-indigo-500 group-hover:to-purple-300 transition-all shadow-sm"
                        style={{ height: `${Math.max(item.pct, 6)}%` }}
                      />
                    </div>
                    <div className="h-[45px] w-full flex items-start justify-center pt-2">
            ...
            <div className="chart-box-card light-card">
              ...
              <div className="donut-center-wrap my-2">
                <svg viewBox="0 0 160 160" className="donut-sources-svg">
                  <circle cx="80" cy="80" r="54" fill="none" stroke="#2563eb" strokeWidth="22" strokeDasharray="64 339" strokeDashoffset="0" />
                  <circle cx="80" cy="80" r="54" fill="none" stroke="#1e3a8a" strokeWidth="22" strokeDasharray="35 339" strokeDashoffset="-66" />
                  <circle cx="80" cy="80" r="54" fill="none" stroke="#ea580c" strokeWidth="22" strokeDasharray="33 339" strokeDashoffset="-103" />
                  <circle cx="80" cy="80" r="54" fill="none" stroke="#7c3aed" strokeWidth="22" strokeDasharray="20 339" strokeDashoffset="-138" />
                  <circle cx="80" cy="80" r="54" fill="none" stroke="#059669" strokeWidth="22" strokeDasharray="187 339" strokeDashoffset="-160" />
                </svg>
              </div>
              <div className="space-y-1 text-xs mt-1">
                <div className="flex items-center justify-between"><span className="flex items-center gap-1.5 font-medium"><span className="w-2.5 h-2.5 rounded-full bg-blue-600" /> Nagpur</span> <span className="font-bold">1.25K (18.8%)</span></div>
                <div className="flex items-center justify-between"><span className="flex items-center gap-1.5 font-medium"><span className="w-2.5 h-2.5 rounded-full bg-blue-900" /> Gadchiroli</span> <span className="font-bold">0.69K (10.4%)</span></div>
                <div className="flex items-center justify-between"><span className="flex items-center gap-1.5 font-medium"><span className="w-2.5 h-2.5 rounded-full bg-orange-600" /> Pune</span> <span className="font-bold">0.65K (9.8%)</span></div>
                <div className="flex items-center justify-between"><span className="flex items-center gap-1.5 font-medium"><span className="w-2.5 h-2.5 rounded-full bg-purple-600" /> Bhandara</span> <span className="font-bold">0.4K (6.0%)</span></div>
                <div className="flex items-center justify-between"><span className="flex items-center gap-1.5 font-medium"><span className="w-2.5 h-2.5 rounded-full bg-emerald-600" /> Chandrapur</span> <span className="font-bold">0.31K (4.7%)</span></div>
              </div>
            </div>
          </div>

          {/* Government Building Annual Capacity Trend (Balanced Pure Line) */}
          <div className="trendline-card-compact light-card">
            <h3 className="chart-box-title">GOVERNMENT SOLAR CAPACITY INSTALLED (MW) OVER YEARS (2018–2026)</h3>
            <div className="svg-trendline-wrap-compact">
              <svg viewBox="0 0 350 150" className="trendline-svg-compact">
                <line x1="30" y1="20" x2="330" y2="20" stroke="#f1f5f9" />
                <line x1="30" y1="68" x2="330" y2="68" stroke="#f1f5f9" />
                ...
                <text x="22" y="24" fontSize="9" fill="#94a3b8" textAnchor="end">65MW</text>
                <text x="22" y="124" fontSize="9" fill="#94a3b8" textAnchor="end">0MW</text>

                <path d="M 43,115 L 103,96 L 163,72 L 223,48 L 283,22" fill="none" stroke="#4f46e5" strokeWidth="2.5" />
                <circle cx="43" cy="115" r="3.5" fill="#4f46e5" />
                <circle cx="103" cy="96" r="3.5" fill="#4f46e5" />
                <circle cx="163" cy="72" r="3.5" fill="#4f46e5" />
                <circle cx="223" cy="48" r="3.5" fill="#4f46e5" />
                <circle cx="283" cy="22" r="5" fill="#6366f1" stroke="#ffffff" strokeWidth="2" />

                <text x="43" y="138" fontSize="9" fill="#64748b" textAnchor="middle">2018</text>
                <text x="103" y="138" fontSize="9" fill="#64748b" textAnchor="middle">2020</text>
                <text x="163" y="138" fontSize="9" fill="#64748b" textAnchor="middle">2022</text>
                <text x="223" y="138" fontSize="9" fill="#64748b" textAnchor="middle">2024</text>
                <text x="283" y="138" fontSize="9" fill="#64748b" textAnchor="middle">2026</text>
              </svg>
            </div>
          </div>
        ...
        /* 5. WIND POWER PROJECTS VIEW WITH MAHARASHTRA GEOGRAPHICAL MAP BELOW LINE GRAPH */
        <div className="category-view-container animate-fade-in space-y-6">
          {/* Executive Top Cards */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="executive-hero-card text-left p-4">
              <div className="ehc-badge-pill">WIND POWER CAPACITY</div>
              <div className="pink-card-val text-3xl">6,371.81 <span className="pink-card-unit">MW</span></div>
              <div className="pink-card-lbl">Sum of Capacity MW</div>
            </div>

            <div className="executive-hero-card text-left p-4">
              <div className="ehc-badge-pill text-cyan-400 border-cyan-400/30 bg-cyan-500/10">TURBINE FARMS</div>
              <div className="pink-card-val text-3xl">3,063</div>
              <div className="pink-card-lbl">Total No. Of Projects</div>
            </div>

            <div className="executive-hero-card text-left p-4">
              <div className="ehc-badge-pill text-amber-300 border-amber-300/30 bg-amber-500/10">TOP DISTRICT</div>
              <div className="pink-card-val text-3xl">1,640 <span className="pink-card-unit">MW</span></div>
              <div className="pink-card-lbl">Satara (25.7% Share)</div>
            </div>

            <div className="executive-hero-card text-left p-4">
              <div className="ehc-badge-pill text-emerald-400 border-emerald-400/30 bg-emerald-500/10">CAPACITY FACTOR</div>
              <div className="pink-card-val text-3xl">28.4%</div>
              <div className="pink-card-lbl">Average Generation Efficiency</div>
            </div>
          </div>

          {/* Bar Chart & Donut Distribution */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 chart-box-card light-card">
              <h3 className="chart-box-title">DISTRICT WISE INSTALLED BY MW (WIND)</h3>
              <div className="h-[260px] flex items-end gap-2 pt-6 pb-2 px-2 overflow-x-auto">
                {[
                  { d: 'Satara', mw: 1640, pct: 100 },
                  { d: 'Sangli', mw: 1420, pct: 86 },
                  { d: 'Dharashiv', mw: 900, pct: 55 },
                  { d: 'Dhule', mw: 580, pct: 35 },
                  { d: 'Beed', mw: 480, pct: 29 },
                  { d: 'Ahmednagar', mw: 350, pct: 21 },
                  { d: 'Nandurbar', mw: 350, pct: 21 },
                  { d: 'Osmanabad', mw: 200, pct: 12 },
                  { d: 'Pune', mw: 110, pct: 7 },
                  { d: 'Nashik', mw: 95, pct: 6 },
                  { d: 'Latur', mw: 85, pct: 5 },
                ].map((item, idx) => (
                  <div key={idx} className="flex-1 flex flex-col items-center justify-end min-w-[36px] h-full group">
                    <span className="text-[9px] font-bold text-slate-600 mb-1 transition-all group-hover:scale-110 group-hover:text-cyan-600">{item.mw}</span>
                    <div className="w-full h-[170px] flex items-end justify-center bg-slate-100/70 rounded-t-md p-[2px]">
                      <div
                        className="w-full bg-gradient-to-t from-cyan-600 to-blue-400 rounded-t-sm group-hover:from-cyan-500 group-hover:to-blue-300 transition-all shadow-sm"
                        style={{ height: `${Math.max(item.pct, 6)}%` }}
                      />
                    </div>
                    <div className="h-[45px] w-full flex items-start justify-center pt-2">
            ...
            <div className="chart-box-card light-card">
              ...
              <div className="donut-center-wrap my-2">
                <svg viewBox="0 0 160 160" className="donut-sources-svg">
                  <circle cx="80" cy="80" r="54" fill="none" stroke="#2563eb" strokeWidth="22" strokeDasharray="87 339" strokeDashoffset="0" />
                  <circle cx="80" cy="80" r="54" fill="none" stroke="#1e3a8a" strokeWidth="22" strokeDasharray="75 339" strokeDashoffset="-89" />
                  <circle cx="80" cy="80" r="54" fill="none" stroke="#ea580c" strokeWidth="22" strokeDasharray="48 339" strokeDashoffset="-166" />
                  <circle cx="80" cy="80" r="54" fill="none" stroke="#7c3aed" strokeWidth="22" strokeDasharray="31 339" strokeDashoffset="-216" />
                  <circle cx="80" cy="80" r="54" fill="none" stroke="#db2777" strokeWidth="22" strokeDasharray="98 339" strokeDashoffset="-249" />
                </svg>
              </div>
              <div className="space-y-1 text-xs mt-1">
                <div className="flex items-center justify-between"><span className="flex items-center gap-1.5 font-medium"><span className="w-2.5 h-2.5 rounded-full bg-blue-600" /> Satara</span> <span className="font-bold">1.64K (25.7%)</span></div>
                <div className="flex items-center justify-between"><span className="flex items-center gap-1.5 font-medium"><span className="w-2.5 h-2.5 rounded-full bg-blue-900" /> Sangli</span> <span className="font-bold">1.42K (22.3%)</span></div>
                <div className="flex items-center justify-between"><span className="flex items-center gap-1.5 font-medium"><span className="w-2.5 h-2.5 rounded-full bg-orange-600" /> Dharashiv</span> <span className="font-bold">0.90K (14.1%)</span></div>
                <div className="flex items-center justify-between"><span className="flex items-center gap-1.5 font-medium"><span className="w-2.5 h-2.5 rounded-full bg-purple-600" /> Dhule</span> <span className="font-bold">0.58K (9.1%)</span></div>
                <div className="flex items-center justify-between"><span className="flex items-center gap-1.5 font-medium"><span className="w-2.5 h-2.5 rounded-full bg-pink-600" /> Beed</span> <span className="font-bold">0.48K (7.5%)</span></div>
              </div>
            </div>
          </div>

          {/* Line Graph: Capacity Installed Over Years */}
          <div className="trendline-card-compact light-card">
            <h3 className="chart-box-title">CAPACITY INSTALLED (MW) OVER YEARS (1995–2026)</h3>
            <div className="svg-trendline-wrap-compact">
              <svg viewBox="0 0 350 150" className="trendline-svg-compact">
                <line x1="30" y1="20" x2="330" y2="20" stroke="#f1f5f9" />
                <line x1="30" y1="68" x2="330" y2="68" stroke="#f1f5f9" />
                ...
                <text x="22" y="24" fontSize="9" fill="#94a3b8" textAnchor="end">6K</text>
                <text x="22" y="124" fontSize="9" fill="#94a3b8" textAnchor="end">0MW</text>

                <path d="M 40,118 L 90,115 Q 140,90 190,62 T 320,22" fill="none" stroke="#0891b2" strokeWidth="2.5" />
                <circle cx="40" cy="118" r="3.5" fill="#0891b2" />
                <circle cx="90" cy="115" r="3.5" fill="#0891b2" />
                <circle cx="190" cy="62" r="3.5" fill="#0891b2" />
                <circle cx="320" cy="22" r="5" fill="#0891b2" stroke="#ffffff" strokeWidth="2" />

                <text x="40" y="138" fontSize="9" fill="#64748b" textAnchor="middle">1995</text>
                <text x="110" y="138" fontSize="9" fill="#64748b" textAnchor="middle">2005</text>
                <text x="180" y="138" fontSize="9" fill="#64748b" textAnchor="middle">2015</text>
                <text x="250" y="138" fontSize="9" fill="#64748b" textAnchor="middle">2020</text>
                <text x="320" y="138" fontSize="9" fill="#64748b" textAnchor="middle">2026</text>
              </svg>
            </div>
          </div>

          {/* MAHARASHTRA GEOGRAPHICAL MAP CONTAINER (PLACED BELOW LINE GRAPH) */}
          <div className="chart-box-card light-card p-5 relative overflow-hidden border border-slate-200/80 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 pb-3 border-b border-slate-100">
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="chart-box-title text-base font-bold text-slate-800 tracking-wide uppercase">
                    REAL OUTLINE MAHARASHTRA WIND ENERGY GEOGRAPHICAL MAP
                  </h3>
                </div>
                <p className="text-xs text-slate-500 mt-0.5 ml-8">
                  State Outline District-wise Installed Capacity Choropleth & Turbine Cluster Distribution
                </p>
              </div>

              {/* District Select Quick Chips */}
              <div className="flex items-center gap-1.5 flex-wrap">
                <span className="text-[11px] font-semibold text-slate-500 mr-1">Quick Select:</span>
                {MAHARASHTRA_WIND_DISTRICTS.slice(0, 6).map((dist) => (
                  <button
                    key={dist.id}
                    onClick={() => setSelectedWindDistrict(dist.id)}
                    className={`px-2.5 py-1 text-xs rounded-full font-medium transition-all ${
                      selectedWindDistrict === dist.id
                        ? 'bg-cyan-700 text-white shadow-sm scale-105'
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
              {/* Left Column: SVG Real Outline Choropleth Map of Maharashtra (8 Cols) */}
              <div className="lg:col-span-8 relative bg-slate-900/95 rounded-2xl p-4 border border-slate-800 shadow-inner overflow-hidden min-h-[440px] flex flex-col justify-between">
                {/* Top overlay badge */}
                <div className="absolute top-4 left-4 z-10 flex items-center gap-2 bg-slate-800/90 backdrop-blur-md px-3 py-1.5 rounded-lg border border-slate-700 text-xs text-slate-200">
                  <Compass size={14} className="text-cyan-400" />
                  <span>State View: <strong>Maharashtra State Geographic Boundary (36 Districts)</strong></span>
                </div>
                ...
                <div className="relative w-full h-[380px] flex items-center justify-center">
                  <svg
                    viewBox="0 0 820 520"
                    className="w-full h-full max-h-[380px] filter drop-shadow-[0_12px_24px_rgba(0,0,0,0.6)]"
                  >
                    <defs>
                      ...
                      {/* Radial pulse glow for active district */}
                    ...
                    {/* Arabian Sea Coastline Backdrop Decor */}
                    <g className="sea-decor opacity-40">
                      <path
                        d="M 15,150 Q 25,160 35,150 Q 45,140 55,150 M 10,280 Q 20,290 30,280 Q 40,270 50,280 M 15,400 Q 25,410 35,400 Q 45,390 55,400"
                        fill="none"
                        stroke="#38bdf8"
                        strokeWidth="1"
                        strokeDasharray="4 4"
                    ...
                    {/* Background Non-Wind Districts */}
                    <g className="other-districts">
                      {MAHARASHTRA_OTHER_DISTRICTS.map((dist) => (
                        <path
                          key={dist.id}
                          d={dist.path}
                          fill="#1e293b"
                          stroke="#334155"
                          strokeWidth="1.2"
                          className="transition-all duration-300 hover:fill-slate-700/60"
                        >
                          <title>{dist.name} (Low / Non-Wind Zone)</title>
                        </path>
                      ))}
                    </g>

                    {/* Wind Producing Districts (Choropleth Layer) */}
                    <g className="wind-districts">
                      {MAHARASHTRA_WIND_DISTRICTS.map((dist) => {
                        const isSelected = selectedWindDistrict === dist.id;
                        const isHovered = hoveredWindDistrict === dist.id;
                        ...
                        return (
                          <g key={dist.id} className="cursor-pointer group">
                            <path
                              d={dist.path}
                              fill={dist.fill}
                              stroke={isSelected ? '#00f2fe' : isHovered ? '#ffffff' : 'rgba(255,255,255,0.45)'}
                              strokeWidth={isSelected ? '2.8' : isHovered ? '2.2' : '1.3'}
                              filter={isSelected || isHovered ? 'url(#glow)' : undefined}
                              className="transition-all duration-200 hover:brightness-125"
                              onClick={() => setSelectedWindDistrict(dist.id)}
                              onMouseEnter={(e) => {
                                setHoveredWindDistrict(dist.id);
                                setMapTooltip({
                                  visible: true,
                                  district: dist,
                                  x: dist.cx + 20,
                              ...
                              onMouseLeave={() => {
                                setHoveredWindDistrict(null);
                                setMapTooltip({ visible: false, district: null, x: 0, y: 0 });
                              }}
                            />
                            ...
                            <text
                              x={dist.cx}
                              y={dist.cy + (dist.id === 'satara' || dist.id === 'sangli' ? 18 : -10)}
                              fontSize="10"
                              fontWeight="700"
                              fill="#ffffff"
                              textAnchor="middle"
                            ...
                            <text
                              x={dist.cx}
                              y={dist.cy + (dist.id === 'satara' || dist.id === 'sangli' ? 28 : 2)}
                              fontSize="8"
                              fontWeight="600"
                              fill="#7dd3fc"
                              textAnchor="middle"
                    ...
                    {/* SVG Floating Tooltip inside Map */}
                    {mapTooltip.visible && mapTooltip.district && (
                      <g
                        transform={`translate(${Math.min(mapTooltip.x, 620)}, ${Math.max(mapTooltip.y, 40)})`}
                      ...
                      >
                        ...
                        />
                        <text x="10" y="20" fontSize="12" fontWeight="800" fill="#38bdf8">
                          {mapTooltip.district.name} ({mapTooltip.district.rank})
                        </text>
                        <text x="10" y="38" fontSize="10" fill="#cbd5e1">
                          Capacity: <tspan fontWeight="700" fill="#ffffff">{mapTooltip.district.mw} MW</tspan> ({mapTooltip.district.pct})
                        </text>
                        <text x="10" y="52" fontSize="9" fill="#94a3b8">
                          Projects: {mapTooltip.district.projects} Turbines
                        </text>
                        <text x="10" y="65" fontSize="9" fill="#94a3b8">
                          Wind Speed: {mapTooltip.district.windSpeed}
                        </text>
                      </g>
                    )}
                  </svg>
                ...
                {/* Map Choropleth Scale Legend */}
                <div className="flex flex-wrap items-center justify-between gap-2 pt-3 border-t border-slate-800 text-[11px] text-slate-300">
                  <div className="flex items-center gap-1.5">
                    <span className="font-semibold text-slate-400">Wind Capacity Scale:</span>
                  </div>
                  <div className="flex items-center gap-3 flex-wrap">
                    <div className="flex items-center gap-1">
                      <span className="w-3 h-3 rounded-sm bg-[#0284c7] inline-block" />
                      <span>&gt; 1,500 MW</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <span className="w-3 h-3 rounded-sm bg-[#0369a1] inline-block" />
                      <span>1.0K–1.5K MW</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <span className="w-3 h-3 rounded-sm bg-[#2563eb] inline-block" />
                      <span>500–1.0K MW</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <span className="w-3 h-3 rounded-sm bg-[#0891b2] inline-block" />
                      <span>300–500 MW</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <span className="w-3 h-3 rounded-sm bg-[#7dd3fc] inline-block" />
                      <span>100–300 MW</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <span className="w-3 h-3 rounded-sm bg-[#1e293b] border border-slate-600 inline-block" />
                      <span>&lt; 100 MW</span>
                    </div>
                  </div>
                </div>
              ...
              {/* Right Column: District Deep-Dive Inspector Card (4 Cols) */}
              <div className="lg:col-span-4 bg-slate-50 border border-slate-200/90 rounded-2xl p-5 flex flex-col justify-between space-y-4">
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-[10px] font-extrabold uppercase tracking-wider text-cyan-700 bg-cyan-100 px-2.5 py-1 rounded-full">
                      DISTRICT INSPECTOR
                    </span>
                    <span className="text-xs font-bold text-slate-500">
                      Rank {currentSelectedDistrictObj.rank} of 11
                    </span>
                  </div>

                  <h4 className="text-2xl font-black text-slate-900 mb-1 flex items-center gap-2">
                    {currentSelectedDistrictObj.name}
                    <span className="text-xs font-normal text-slate-500">({currentSelectedDistrictObj.region})</span>
                  </h4>

                  <div className="my-3 p-3 bg-white rounded-xl border border-slate-200 shadow-sm flex items-center justify-between">
                    <div>
                      <div className="text-[10px] font-bold text-slate-500 uppercase">Installed Wind Power</div>
                      <div className="text-2xl font-black text-cyan-600">
                        {currentSelectedDistrictObj.mw} <span className="text-sm font-bold text-slate-600">MW</span>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-[10px] font-bold text-slate-500 uppercase">State Share</div>
                      <div className="text-lg font-bold text-slate-800">{currentSelectedDistrictObj.pct}</div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1 mb-4">
                    <div className="flex justify-between text-xs font-semibold text-slate-600">
                      <span>Contribution to Maharashtra Total</span>
                      <span>{currentSelectedDistrictObj.pct}</span>
                    </div>
                    <div className="w-full h-2.5 bg-slate-200 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-gradient-to-r from-cyan-600 to-blue-500 rounded-full transition-all duration-500"
                        style={{ width: currentSelectedDistrictObj.pct }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-2.5 text-xs mb-4">
                    <div className="p-2.5 bg-white rounded-lg border border-slate-200">
                      <span className="text-slate-500 block text-[10px] font-medium">Turbine Projects</span>
                      <span className="font-bold text-slate-800 text-sm">{currentSelectedDistrictObj.projects} Farms</span>
                    </div>
                    <div className="p-2.5 bg-white rounded-lg border border-slate-200">
                      <span className="text-slate-500 block text-[10px] font-medium">Avg Wind Velocity</span>
                      <span className="font-bold text-slate-800 text-sm">{currentSelectedDistrictObj.windSpeed}</span>
                    </div>
                  </div>

                  {/* Key Wind Farms List */}
                  <div className="p-3 bg-cyan-50/60 rounded-xl border border-cyan-100">
                    <div className="text-[11px] font-bold text-cyan-800 mb-1 flex items-center gap-1">
                      <Layers size={13} />
                      Major Wind Parks & Clusters:
                    </div>
                    <div className="text-xs text-slate-700 font-medium">
                      {currentSelectedDistrictObj.farms}
                    </div>
                  </div>
                </div>

                {/* Leaderboard selector list */}
                <div>
                  <div className="text-xs font-bold text-slate-700 mb-2">Top Producing Wind Districts:</div>
                  <div className="space-y-1.5 max-h-[140px] overflow-y-auto pr-1">
                    {MAHARASHTRA_WIND_DISTRICTS.map((item) => (
                      <div
                        key={item.id}
                        onClick={() => setSelectedWindDistrict(item.id)}
                        className={`flex items-center justify-between p-2 rounded-lg text-xs cursor-pointer transition-all ${
                          selectedWindDistrict === item.id
