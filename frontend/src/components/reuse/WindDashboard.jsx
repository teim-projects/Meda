...
const PALETTE = [
  ...
  '#3b82f6', '#10b981', '#15803d', '#b45309', '#6d28d9',
  '#be185d', '#047857', '#0369a1', '#a16207', '#4338ca',
  '#9f1239', '#0f766e', '#1d4ed8', '#c05621', '#5b21b6',
  '#831843', '#166534', '#075985', '#92400e', '#3730a3', '#881337'
];
                          ...
                          onMouseEnter={() =>
                            setActivePieHover({
                              ...
                              sub: slice.isOther 
                                ...
                                : `${slice.percentage}% (${slice.count.toLocaleString()} turbines)`
                            })
                          }
                        ...
                        onMouseEnter={() =>
                          setActivePieHover({
                            ...
                            sub: item.isOther 
                              ...
                              : `${item.percentage}% (${item.count.toLocaleString()} turbines)`
                          })
                        }
                        onMouseLeave={() => setActivePieHover(null)}
                      >
